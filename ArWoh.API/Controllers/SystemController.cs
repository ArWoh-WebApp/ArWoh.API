    ...
    private async Task SeedUsersAndImages()
    {
        ...
        var images = new List<Image>
        {
            ...
            new()
            {
                ...
                Url =
                    "https://minio.ae-tao-fullstack-api.site/api/v1/buckets/arwoh-bucket/objects/download?preview=true&prefix=artworks%2FIMG_2329.jpg&version_id=null",
                Orientation = OrientationType.Portrait,
            ...
            new()
            {
                ...
                Url =
                    "https://minio.ae-tao-fullstack-api.site/api/v1/buckets/arwoh-bucket/objects/download?preview=true&prefix=artworks%2FIMG_2327.jpg&version_id=null",
                Orientation = OrientationType.Landscape,
